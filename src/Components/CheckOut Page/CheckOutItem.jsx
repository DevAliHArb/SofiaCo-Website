        ...
        {productData.map((props) => (
          ...
          <div className={classes.card} key={props._id}>
            ...
            <div style={{height:'100%',justifyContent:'space-between',width:'20em',display:'flex', flexDirection:'column', margin:'auto 0',fontSize:'calc(.7rem + 0.3vw)',fontFamily:'var(--font-family)'}}>
              ...
              <p style={{color:'var(--secondary-color)',fontSize:'calc(.7rem + 0.3vw)',fontWeight:'700',width:"97%",textAlign:'start'}}>{props.title}</p>
            ...
            <p style={{margin:'auto 0',fontWeight:'700',color:'var(--secondary-color)',fontSize:'larger',fontFamily:"var(--font-family)"}}>${(props.quantity * props.price).toFixed(2)}</p>
            </div>
