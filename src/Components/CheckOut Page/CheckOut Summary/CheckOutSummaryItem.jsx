      ...
      <>
        {data?.map((props) => (
          ...
          <div className={classes.card} key={props._id}>
            ...
            <div style={{height:'100%',justifyContent:'space-between',display:'flex', flexDirection:'column', margin:'auto 0',width:'fitcontent',fontSize:'calc(.7rem + 0.3vw)',fontFamily:'montserrat'}}>
