...
const Coupons = () => {
  ...
  const AddCoupon = async () => {
    ...
    try {
      ...
      const couponResponse = await axios.get(
        `${import.meta.env.VITE_TESTING_API}/api/bookshop/coupons?ecom_type=sofiaco&code=${thecoupon}`,
        {
          headers: {
            Authorization: `Bearer ${token}`, // Include token in the headers
          },
      ...
      await axios.post(
        `${import.meta.env.VITE_TESTING_API}/api/bookshop/users/${userId}/coupons`,
        {
          coupon_id: `${coupon.id}`,
        },
        {
  ...
  const handleDeleteCoupon = async (id) => {
    try {
      ...
      await axios.delete(
        `${import.meta.env.VITE_TESTING_API}/api/bookshop/users/${user.id}/coupons/${userCouponId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`, // Include token in the headers
          },
