...
const Register = () => {const navigate = useNavigate();
  ...
  const [loading, setLoading] = useState(false);
    ...
    const onFinish = async (values) => {
        setLoading(true)
        try {
          const updatedFormData = { ...formData,business_area: formData?.company_country, active: 'false', google: "false", type:'sofiaco', database_sous_domaine: import.meta.env.VITE_DATABASE_NAME };
